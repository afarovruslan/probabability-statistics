...
\solution{
  Так как нормальное распределение из экспоненциального семейства, $T(X) = \sum_{i = 1}^n X_i^2$ является полной достаточной статистикой. Решая уравнение несмещённости, получаем $S(X) = \frac{n}{n - 1}\overline{X^2}$ - оптимальная оценка $\theta$
}
\problem{
